<x-app-layout>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500 mt-0.5">Kelola program studi dan jurusan yang tersedia
                                </p>
                            </div>
                            <span
                                class="inline-flex items-center rounded-full bg-blue-50 px-2.5 py-0.5 text-xs font-semibold text-blue-700 ring-1 ring-inset ring-blue-700/10 ml-2">
                                    ...
                                    @forelse ($jurusan as $j)
                                        <tr class="hover:bg-slate-50/80 transition-colors duration-150 group">
                                            <td class="whitespace-nowrap px-6 py-4">
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        class="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center">
                                                ...
                                                <div class="flex flex-col items-center justify-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-slate-400 mt-1">Silakan klik tombol
                                                            "Tambah Jurusan" untuk menambahkan</p>
                                                    </div>
                                                    <a href="{{ route('jurusan.create') }}"
                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <a href="{{ route('jurusan.create') }}"
                                    class="text-sm font-semibold text-purple-600 hover:text-purple-700">Tambah Baru
                                    →</a>
                            </div>
                        </div>
                    </div>
    ...
    <a href="{{ route('jurusan.export-excel') }}" target="_blank" class="btn btn-success">
        Export Excel
    </a>
