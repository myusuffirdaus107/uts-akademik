                ...
                <div class="px-6 py-5 border-b border-slate-200 bg-white/95 backdrop-blur-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">Kelola mata kuliah yang tersedia pada program studi</p>
                        </div>
                        <span class="inline-flex items-center rounded-full bg-purple-50 px-2.5 py-0.5 text-xs font-semibold text-purple-700 ring-1 ring-inset ring-purple-700/10 ml-2">
                                ...
                                <tr>
                                    <td colspan="2" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-base font-medium text-slate-500">Belum ada data matakuliah</p>
                                                <p class="text-sm text-slate-400 mt-1">Silakan klik tombol "Tambah Matakuliah" untuk menambahkan</p>
                                            </div>
                                            <a href="{{ route('matakuliah.create') }}" 
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <a href="{{ route('matakuliah.create') }}" class="text-sm font-semibold text-pink-600 hover:text-pink-700">Tambah Baru →</a>
                        </div>
                    </div>
                </div>
            </div>
